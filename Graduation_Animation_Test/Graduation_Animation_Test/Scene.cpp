...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, 45); //SuperCobra(17), Gunship(2), Player:Mi24(1), Angrybot(2)
	...
	CGameObject *pAngrybotModel1 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/P03.bin", NULL, true);
	CGameObject* pAngrybotModel2 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/P03.bin", NULL, true);
	CGameObject* pAngrybotModel3 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/P03.bin", NULL, true);
	...
	m_ppHierarchicalGameObjects[0]->SetChild(pAngrybotModel1, true);
	...
	m_ppHierarchicalGameObjects[1]->SetChild(pAngrybotModel2, true);
	...
	m_ppHierarchicalGameObjects[2] = new CAngrybotObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
	m_ppHierarchicalGameObjects[2]->SetChild(pAngrybotModel3, true);
	m_ppHierarchicalGameObjects[2]->SetPosition(450.0f, m_pTerrain->GetHeight(450.0f, 680.0f), 660.0f);
	m_ppHierarchicalGameObjects[2]->SetScale(2.0f, 2.0f, 2.0f);
			...
			case '5':
				if (m_ppHierarchicalGameObjects)
					for (int i = 0 ; i < m_nHierarchicalGameObjects; ++i)
						m_ppHierarchicalGameObjects[i]->SetAnimationSet(int(wParam) - '1');
				break;
		}
		break;
	default:
