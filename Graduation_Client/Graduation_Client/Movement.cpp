...
void TaggerMovement::start(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
}

void TaggerMovement::update(float elapsedTime)
{
	if (GameState::GetInstance()->GetChatState()) return;
	if (GameState::GetInstance()->GetGameState() == SPECTATOR_GAME) return;
	UCHAR keyBuffer[256];
...
void SurvivorMovement::start(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
}

void SurvivorMovement::update(float elapsedTime)
{
	if (GameState::GetInstance()->GetChatState()) return;
	if (GameState::GetInstance()->GetGameState() == SPECTATOR_GAME) return;
	UCHAR keyBuffer[256];
...
void DeadMovement::start(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
}

void DeadMovement::update(float elapsedTime)
{
	if (GameState::GetInstance()->GetChatState()) return;
	if (GameState::GetInstance()->GetGameState() == SPECTATOR_GAME) return;
	UCHAR keyBuffer[256];
