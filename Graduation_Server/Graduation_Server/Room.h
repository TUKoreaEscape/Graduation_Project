...
// 데모용 게임
#if DEMO
#define SELECT_TAGGER_SECOND 9
#define FIRST_TAGGER_SKILL_OPEN_SECOND 10
#define SECOND_TAGGER_SKILL_OPEN_SECOND 10
#define THIRD_TAGGER_SKILL_OPEN_SECOND 10
#define GAME_END_SECOND 600
#define GAME_END_COLLECT_CHIP 2
#endif

// 실제 게임용
#if !DEMO
#define SELECT_TAGGER_SECOND 59
